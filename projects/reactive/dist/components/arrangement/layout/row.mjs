...
import { isNil, isPlainObject, isString, forEach, isEmpty } from 'lodash-es';
...
function Row(props, ref) {
    const { className, justify, align, gutter, enableBefore, enableAfter, children, before, after, style = {}, ...rest } = props;
    ...
    const classNames = classnames('layout-row', buildClass(justify, 'justify'), buildClass(align, 'align'), buildClass(beforeFinal, 'before'), buildClass(afterFinal, 'after'), gutterClasses, className);
    return (React.createElement("div", { ...rest, ref: ref, className: classNames, style: {
            ...style,
            ...gutterStyles,
        } }, children));
}
