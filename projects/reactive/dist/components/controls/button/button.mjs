...
import { getSchemeColorClasses } from '../../../common/color-list.mjs';
...
class Button extends PureComponent {
    ...
    render() {
        const { className, design, color, children, variant, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        focusOnMount, Component, ...rest } = this.props;
        ...
        const props = {
            ref: this.buttonRef,
            className: classnames('ra-button', 'no-select', 'ra-clr-int-control', colorClasses, className, {
