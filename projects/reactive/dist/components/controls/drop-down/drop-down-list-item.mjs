...
function DropDownListItem(props) {
    const { id, color, className, selected, targeted, children, 'aria-label': ariaLabel, borderBottom, borderTop, onClick, preventCloseOnClick, ...rest } = props;
    ...
    return (React.createElement("li", { ...rest, ref: itemRef, id: id, className: classnames('ra-dd-list-item', className, colorClasses, {
            selected,
            targeted,
            'border-bottom': borderBottom,
            'border-top': borderTop,
        }), role: "option" // TODO: Review how this is not clickable anymore
        , "aria-selected": selected || false, "aria-current": ariaCurrent, "aria-label": accessibilityLabel, onClick: handleClick }, children));
}
