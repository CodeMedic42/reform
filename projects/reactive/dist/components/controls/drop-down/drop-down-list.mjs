...
class DropDownList extends Component {
    ...
    handleWheel(event) {
        ...
        const { scrollTop, scrollLeft, scrollHeight, scrollWidth, clientHeight, clientWidth, } = this.listRef.current;
    ...
    render() {
        const { id, className, children, size, 'aria-labelledby': ariaLabeledBy, } = this.props;
        const sizeClass = !isNil(size) ? `size-${size}` : 'size-md';
        return (React.createElement("ol", { ref: this.listRef, id: id, className: classnames('ra-dd-list', className, sizeClass), role: "listbox", "aria-labelledby": ariaLabeledBy }, children));
    }
}
