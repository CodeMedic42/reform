...
function Paragraph(props) {
    const { className, size, weight, forwardRef, children, ...rest } = props;
    const weightClass = !isNil(weight) ? `weight-${weight}` : null;
    const sizeClass = !isNil(size) ? `size-${size}` : null;
    return (React.createElement(Typography, { ref: forwardRef, Component: "p", className: classnames('ra-paragraph', sizeClass, className, weightClass), ...rest }, children));
}
Paragraph.propTypes = {
...
applyForwardRef(memo(Paragraph));
