import React, { forwardRef, useState, useCallback, useMemo, useImperativeHandle } from 'react';
import classnames from 'classnames';
import { isNil } from 'lodash-es';
import DateRangeInputAnchor from './date-range-input-field-anchor.mjs';
import DateBase from '../new-base/date/date-base.mjs';
import '../../../common/prop-types.mjs';
import PropTypes from 'prop-types';

const DateRangeInput = forwardRef((props, ref) => {
    // } = props;
    const { value, className, onChange, leftAnnotation, rightAnnotation, minDate, maxDate, ...rest } = props;
    ...
    return (React.createElement(DateBase, { ...rest, className: classnames('ra-date-range-input', className), fromDate: fromDate, toDate: toDate, onSelect: handleSelect, Anchor: DateRangeInputAnchor, anchorProps: anchorProps, minDate: minDate, maxDate: maxDate }));
});
