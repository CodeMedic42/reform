...
import NumericInputBase from './numeric-input-field-base.mjs';
import PropTypes from 'prop-types';

const NumericInputField = forwardRef((props, ref) => {
