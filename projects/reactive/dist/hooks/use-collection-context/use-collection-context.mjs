...
import useFilterSettings from './use-filter-settings.mjs';
import useSortSettings from './use-sort-settings.mjs';
...
function appendItems(items, newItems, getId, beforeInsert, filterState, sortState) {
    ...
    const listItems = map(newItems, (newItem, index) => {
        ...
        const collectionItem = new CollectionItem(id, finalItem, count + index, ACCESS_SYMBOL);
